...
<link rel="stylesheet" href="/template/additionalFiles/statProductsTotal/statProductsTotal.css">
<script type="text/javascript" src="/template/additionalFiles/statProductsTotal/statProductsTotal.js"></script>
...
<table id="table-list" class="stat-total-table" border="0" cellspacing="0">
    <thead>
        <tr>
            <td>Дата</td>
            <td>Заявок</td>
